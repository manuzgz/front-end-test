...
const ProductDescription = (props) => {
    ...
    return (
            ...
            <p className={classes.productId}>Ref. {product.id}</p>
            <ul>
            ...
            <li>Back Camera: {Array.isArray(pCamera) ? pCamera.join(', ') : pCamera}</li>
            <li>Front Camera: {Array.isArray(sCamera) ? sCamera.join(', ') : sCamera}</li>
